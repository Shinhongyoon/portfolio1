...
(function(w) {
    ...
    try {
        var links = ["https:\/\/s.ad.smaato.net\/c\/?dspInit=1001376\u0026dspCookie=bcaf8c891fd5cdbf1b9a6905ee8c6a31","https:\/\/sync.taboola.com\/sg\/widerplanetkorea-network\/1\/rtb-h\/?taboola_hm=bcaf8c891fd5cdbf1b9a6905ee8c6a31","https:\/\/sbm.nate.com\/setCookie?venderKey=wider\u0026userKey=bcaf8c891fd5cdbf1b9a6905ee8c6a31"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-bcaf8c891fd5cdbf1b9a6905ee8c6a31-s1653378312.559000|windows_10|chrome-nle0ma", 365);
                return;
            }
        }
...
(function(w) {
    try {
        ...
        identity.setCookie("_molecule_id", "bcaf8c891fd5cdbf1b9a6905ee8c6a31", 365);
